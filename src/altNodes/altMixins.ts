...
export interface AltReactionMixin extends ReactionMixin {}
...
export class AltComponentNode {
	readonly type = 'COMPONENT'
}
export class AltInstanceNode {
...
interface AltComponentMixin {}

export interface AltComponentNode
	extends AltComponentMixin,
		AltDefaultShapeMixin,
		AltBaseNodeMixin,
		AltLayoutMixin {}

export interface AltInstanceNode
	extends AltComponentMixin,
		AltDefaultShapeMixin,
		AltBaseNodeMixin,
		AltLayoutMixin {
